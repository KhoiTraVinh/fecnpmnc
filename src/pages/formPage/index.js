  ...
  return (
    <div className="bookingInfo">
      <div className="bookingInfoTopbar">
        <div className="bookingInfoTopbarLeft">
          <h2 className="logo">
            <Link to="/">
        ...
        <div className="bookingInfoTopbarRight">
          <div className="bookingInfoTopbarRight1">
            <div className="count">1</div>
            Thông tin chi tiết
          </div>
          <Remove className="bookingInfoTopbarIcon" />
          <div className="bookingInfoTopbarRight2">
            <div className="count2">2</div>
            Thanh toán
          </div>
        </div>
      </div>
      <div className="bookingInfoBody">
        <div className="bookingInfoBodyTitle">
          <div className="bookingInfoBodyTitle1">Đặt chỗ của tôi</div>
          <div className="bookingInfoBodyTitle2">
            Điền thông tin và xem lại đặt chỗ.
          </div>
          <div className="bookingInfoBodyWidget">
            <div className="bookingInfoBodyWidgetLeft">
              <div className="cover">
                <span className="bookingInfoBodyWidgetLeftTitle">
                  Thông tin liên hệ
                </span>
                <form className="formTop">
                  <div className="formTopTitle">Thông tin liên hệ</div>
                  <hr />
                  <div className="formTopName">
                    <div className="formTopNameCover">
                      <span className="firstName">Họ</span>
                      <input
                        type="text"
                        className="nameInput"
                    ...
                    <div className="formTopNameCover">
                      <span className="firstName">Tên Đệm & Tên</span>
                      <input
                        type="text"
                        className="nameInput"
              ...
              <div className="cover">
                ...
                <form className="formTop">
                  ...
                  <div className="formTopContact">
                    <div className="formTopContactPhone1">
                      <Stack component="form" noValidate spacing={3}>
                        <TextField
                          id="date"
                          label="Ngày sinh"
                          type="date"
                          defaultValue="2000-02-22"
                          InputLabelProps={{
                            shrink: true,
                          }}
                        />
                  ...
                  <div className="formTopContact">
                    ...
                    <div className="formTopContactPhone">
                      <span className="firstName">Quốc tịch</span>
                      <Autocomplete
                      ...
                      />
                      <h3 className="nameDetail">Việt Nam</h3>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div className="bookingInfoBodyWidgetRight">
              <div className="bookingInfoBodyWidgetRightTop">
                <div className="cover1">
                  <ListAlt className="bookingInfoBodyWidgetRightTopIcon" />
                  <span className="bookingInfoBodyWidgetRightTopTitle">
              ...
              <div className="bookingInfoBodyWidgetRightTop">
                <div className="cover1">
                  <Hotel className="bookingInfoBodyWidgetRightTopIcon" />
                  <span className="bookingInfoBodyWidgetRightTopTitle">
                    Thông tin khách sạn
                  </span>
                </div>
                ...
                <div className="tenhangbay">
                  <h3 className="tenhang">Hạng phòng</h3>
                  <h3 className="tenhang1">:Vip</h3>
                </div>

                <div className="tenhangbay">
                  <h3 className="tenhang">Số phòng</h3>
                  <h3 className="tenhang1">:1</h3>
                </div>

                <h3 className="aservice1">
                  <CheckCircleOutline className="serviceIcon" /> Có thể hoàn lại
                  tiền
                </h3>
              </div>
            </div>
